...
主要是对snowflake模式的测试，以及源代码的分析；对号段模式未看。

主要是在zookeeper 单机版进行测试。

主要是在zookeeper 单机版进行测试。

具体可以查看自己的博客专栏[美团Leaf源码——snowflake模式源码解析](https://blog.csdn.net/m0_37941483/article/details/103238281)
